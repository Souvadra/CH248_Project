function dydt = dynamic_simulation_fission_yeast_cc_normal(t,y,parameter_set)
    ...
    dydt(1) = ga*H_Start_Start*H_Start_SK - ka*Start;
    dydt(2) = gb*H_SK_Start*H_SK_Ste9*H_SK_Rum1 - kb*SK;
    dydt(3) = gc*H_Ste9_Cdc2byCdc13*H_Ste9_Cdc2byCdc13Star - kc*Ste9;
    dydt(4) = gd*H_Rum1_Cdc2byCdc13*H_Rum1_Cdc2byCdc13Star - kd*Rum1;
    dydt(5) = ge*H_Cdc2byCdc13_Ste9*H_Cdc2byCdc13_Rum1*H_Cdc2byCdc13_Wee1byMik1*H_Cdc2byCdc13_Cdc25 - ke*Cdc2byCdc13;
    dydt(6) = gf*H_Cdc2byCdc13Star_Ste9*H_Cdc2byCdc13Star_Rum1*H_Cdc2byCdc13Star_Slp1 - kf*Cdc2byCdc13Star;
    dydt(7) = gg*H_PP_PP*H_PP_Ste9*H_PP_Rum1*H_PP_Wee1byMik1*H_PP_Cdc25 - kg*PP;
