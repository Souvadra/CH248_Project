# Topic: Understanding the dynamics of a complex biological networks without parameter information: Case study on the cell-cycle networkof fssion-yeast (*S.pombe*)
